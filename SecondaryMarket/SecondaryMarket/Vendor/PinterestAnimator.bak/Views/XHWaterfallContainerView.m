...
//    self.imageView.image = displayPinterest.imageURL;
    [self.imageView setImageWithURL:[NSURL URLWithString:displayPinterest.imageURL]];
//    [self.imageView setImageWithURL:<#(NSURL *)#>]
